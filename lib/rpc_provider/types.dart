...
class JsonRpcRequest extends JsonRpcObject {
  String? method;
  dynamic params;
  JsonRpcRequest({id, jsonrpc, this.method, this.params})
      : super(id: id, jsonrpc: '2.0');
...
class JsonRpcResponseSingle {
  ...
  factory JsonRpcResponseSingle.fromMap(Map<String, dynamic> map) =>
...
class JsonRpcResponseSubscription {
  ...
  JsonRpcResponseSubscription({required this.method, required this.params});
  factory JsonRpcResponseSubscription.fromMap(Map<String, dynamic> map) {
    final _error = map["params"] != null && map["params"]["error"] != null
        ...
        : null;
    final _result = map["params"] != null && map["params"]["result"] != null
        ? map["params"]["result"]
        : null;
    final _subscription = map["params"] != null && map["params"]["subscription"]
        ? map["params"]["subscription"]
        : null;
    return JsonRpcResponseSubscription(method: map["method"], params: {
      "error": _error,
      "result": _result,
...
class JsonRpcResponseBase
    implements JsonRpcResponseSingle, JsonRpcResponseSubscription {
  @override
  JsonRpcResponseBaseError? error;
  ...
  JsonRpcResponseBase(
      {this.error, required this.method, required this.params, this.result});
    ...
    final _params = {
      "error": map["params"] != null && map["params"]["error"] != null
          ? map["params"]["error"] is JsonRpcResponseBaseError
              ...
              : JsonRpcResponseBaseError.fromMap(map["params"]["error"])
          : null,
      "result": map["params"] != null && map["params"]["result"] != null
          ? map["params"]["result"]
          : null,
      "subscription":
          map["params"] != null && map["params"]['subscription'] != null
              ? map["params"]['subscription']
              : null
    };
    final _result = map["result"];
    return JsonRpcResponseBase(
        error: _error, params: _params, method: _method, result: _result);
  }
  @override
  toMap() {
    return {
...
typedef ProviderInterfaceCallback = void Function(
...
extension ProviderInterfaceEmittedExt on ProviderInterfaceEmitted {
  ...
  static ProviderInterfaceEmitted fromString(String value) {
    return ProviderInterfaceEmitted.values.firstWhere(
        (element) =>
            element.name == value.replaceFirst("ProviderInterfaceEmitted.", ""),
        orElse: () => throw "$value is not in ProviderInterfaceEmitted.");
  }

  static Iterable<String> get names =>
      ProviderInterfaceEmitted.values.map((e) => e.name);
...
abstract class ProviderInterface {
  ...
  Future<dynamic> subscribe(String type, String method, List<dynamic> params,
      ProviderInterfaceCallback cb);
